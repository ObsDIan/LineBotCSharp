    ...
    public class HKContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Application>().HasData(
                new Application { ApplicationId = 1, MemberId = 1, ApplicationName = "華電", Key = "華電" }
                );

            modelBuilder.Entity<Aifile>().HasData(
                new Aifile { AifileId = 1, AifileType = "json", AifilePath = "Upload/001.json", ApplicationId = 1, Language = "en" }
            );
